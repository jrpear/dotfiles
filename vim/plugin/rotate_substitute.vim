" Copyright (C) 2015 Luc Hermitte

" This file is part of lh-vim.  This program is free software; you can
...
" of the Autoconf Configure Script Exception along with this program; see the
" files COPYING and COPYING.EXCEPTION respectively.  If not, see
